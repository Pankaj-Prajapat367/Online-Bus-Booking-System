...
class main_fn:
    def front(self):
        ...
        Label(root,text='Name : PANKAJ PRAJAPAT',fg='blue2',font="Arial 11 bold",pady=25).pack()

        Label(root,text='Er : 221B259',fg='blue2',font="Arial 11 bold",pady=25).pack()

        Label(root,text='Mobile :  1234122412',fg='blue2',font="Arial 11 bold",pady=25).pack()

        Label(root,text='Submitted to : Dr. Mahesh Kumar ',fg='Red',bg='LightBlue1',font="Arial 15 bold").pack()

        Label(root,text='',fg='blue2',font="Arial 11 bold",pady=25).pack()
        
        Label(root,text='',fg='blue2',font="Arial 11 bold",pady=25).pack()
        
        Label(root,text='',fg='blue2',font="Arial 11 bold",pady=25).pack()

        Label(root,text='[PRESS ANY KEY TO CONTINUE]',fg='Red',font="Times 7 bold").pack()
    ...
    def booking(self):
        ...
        Label(root,text='Online Bus Booking System',fg='Red',bg='LightBlue1',font="Arial 16 bold",borderwidth=0,relief="ridge").grid(row=1,column=0,padx=400,columnspan=7,pady=10)

        Label(root,text="Enter Journey Details",bg="light green",fg="green",font="Arial 10 bold",borderwidth=0,relief="ridge").grid(row=3,column=0,columnspan=7)
